...
$(function () {
    ...
    for (var i = 1; i <= 8; i++) {
        ...
        html_content += `
            <div class="tab-pane ${is_active}" id="tab-${i}">
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-md-2 control-label">Contract</label>
                            <div class="col-md-10">
                                <select class="form-control select contractlist" id="contract${i}" name="contract[${i}]"></select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">Industry</label>
                            <div class="col-md-10">
                                <select class="form-control select industry" id="industry${i}" name="industry[${i}]"></select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">Sub Industry</label>
                            <div class="col-md-10">
                                <select class="form-control select sub_industry" id="sub_industry${i}" name="sub_industry[${i}]"></select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">Advertiser</label>
                            <div class="col-md-10">
                                <select class="form-control select" id="advertiser${i}" name="advertiser[${i}]"></select>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.data, function (k, v) {
                ...
                var arr_dropdown = ['ooh_type', 'kode_produk', 'type_produk', 'orientasi', 'lighting', 'ownerOOH', 'jumlah_sisi', 'fixing', 'competition', 'visible_distance', 'angle_of_vision', 'obstruction', 'street_lite', 'road_type'];
...
function initialLoadData(lvl) {
    ...
    $.ajax({
        ...
        dataType: 'json',
        success: function (data) {
            console.log("FILTER INDUSTRY", data);
            if (typeof data != 'object') { data = $.parseJSON(data); }
            var optionsAsString = "";
...
function infoSave() {
    var forms = new FormData($("#forminfo")[0]);
    var convertForm = Object.fromEntries(forms);
    convertForm['owner'] = convertForm['ownerOOH'];
    delete convertForm['ownerOOH'];
    var newForm = getFormData(convertForm);
